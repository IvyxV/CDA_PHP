...
// C'est un tableau associatif, dont chaque clé est un nombre, et chaque valeur est une instance de la classe Article (autrement dit, un objet de type Article).
$dataArticlesList = [
    1 => new Article(
